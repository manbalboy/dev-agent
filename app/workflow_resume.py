...
def build_workflow_artifact_paths(repository_path: Path) -> Dict[str, Path]:
    ...
    return {
        ...
        "assistant_diagnosis_trace": docs_dir / "ASSISTANT_DIAGNOSIS_TRACE.json",
        "runtime_recovery_trace": docs_dir / "RUNTIME_RECOVERY_TRACE.json",
        "provider_failure_counters": docs_dir / "PROVIDER_FAILURE_COUNTERS.json",
        "operator_inputs": docs_dir / "OPERATOR_INPUTS.json",
        "integration_recommendations": docs_dir / "INTEGRATION_RECOMMENDATIONS.json",
        "integration_guide_summary": docs_dir / "INTEGRATION_GUIDE_SUMMARY.md",
        "integration_code_patterns": docs_dir / "INTEGRATION_CODE_PATTERNS.md",
        "integration_verification_checklist": docs_dir / "INTEGRATION_VERIFICATION_CHECKLIST.md",
        "integration_usage_trail": docs_dir / "INTEGRATION_USAGE_TRAIL.json",
        "mobile_app_checklist": docs_dir / "MOBILE_APP_CHECKLIST.md",
        "mobile_e2e_result": docs_dir / "MOBILE_E2E_RESULT.json",
        "followup_backlog_task": docs_dir / "FOLLOWUP_BACKLOG_TASK.json",
        "self_growing_effectiveness": docs_dir / "SELF_GROWING_EFFECTIVENESS.json",
        "vector_shadow_index": docs_dir / "VECTOR_SHADOW_INDEX.json",
        "langgraph_planner_shadow": docs_dir / "LANGGRAPH_PLANNER_SHADOW.json",
        "langgraph_recovery_shadow": docs_dir / "LANGGRAPH_RECOVERY_SHADOW.json",
