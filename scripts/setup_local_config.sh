...
AGENTHUB_SELF_CHECK_STALE_MINUTES=45
AGENTHUB_SELF_CHECK_ALERT_WEBHOOK_URL=
AGENTHUB_SELF_CHECK_ALERT_CRITICAL_WEBHOOK_URL=
AGENTHUB_SELF_CHECK_ALERT_WEBHOOK_TIMEOUT_SECONDS=10
AGENTHUB_SELF_CHECK_ALERT_REPEAT_MINUTES=180
AGENTHUB_SELF_CHECK_ALERT_FAILURE_BACKOFF_MAX_MINUTES=720
AGENTHUB_PUBLIC_BASE_URL=http://127.0.0.1:$API_PORT
AGENTHUB_ENFORCE_HTTPS=false
AGENTHUB_TRUST_X_FORWARDED_PROTO=false
AGENTHUB_CORS_ALLOW_ALL=false
AGENTHUB_CORS_ORIGINS=http://127.0.0.1:$API_PORT,http://localhost:$API_PORT
EOF
